...
import com.kuit.kuit5.ui.asset.component.FinancialServiceContainer
        ...
        Column(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(text = "페이머니", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                    Text(text = "0원", fontSize = 14.sp, color = Color(0xFF666668))
                }
                Spacer(modifier = Modifier.height(30.dp))
                Row(
                    modifier = Modifier
                    ...
                    Row(
                        ...
                        Icon(
                            modifier = Modifier
                                .size(30.dp),
                            painter = painterResource(id = R.drawable.img_assets_banksalad),
                            contentDescription = "bancsalad icon",
            ...
            Column(
                ...
                Row(
                    ...
                    Text(text = "신용", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                    Row(
                        verticalAlignment = Alignment.CenterVertically
                    ) {
                        Text(
            ...
            Column(
                ...
                FinancialServiceContainer(
                    title = "카드",
                    content = "내게 맞는 추천카드는?",
                    img = R.drawable.img_assets_card
                )
            }
            Spacer(modifier = Modifier.height(22.dp))
            Spacer(
            ...
            Column(
                ...
                FinancialServiceContainer(
                    title = "대출",
                    content = "내 최저 금리는?",
                    img = R.drawable.img_assets_loan
                )
            }
            Spacer(modifier = Modifier.height(22.dp))
            Spacer(
            ...
            Column(
                ...
                FinancialServiceContainer(
                    ...
                    img = R.drawable.img_assets_insurance
                )
            }
            Spacer(modifier = Modifier.height(22.dp))
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Text(text = "편집하기", fontSize = 14.sp, color = Color(0xFF666668))
                        Spacer(modifier = Modifier.width(46.dp))
                        VerticalDivider(modifier = Modifier.height(22.dp))
                        Spacer(modifier = Modifier.width(46.dp))
                        Text(text = "추가하기", fontSize = 14.sp, color = Color(0xFF666668))
                    }
                }

            }
        }//topAppBar 제외 전체 화면 EndPoint
    }
}

//tint = Color.unspecified <= svg 파일 색깔 나타나게끔
