...
@Composable
fun HorizontalBannerCard(modifier: Modifier = Modifier) {
    Card(
        modifier = modifier
            ...
            Box(
                ...
                Image(
                    modifier = Modifier
                        .padding(horizontal = 20.dp)
                        .size(40.dp),
                    painter = painterResource(id = R.drawable.img_home_papermoney),
                    contentDescription = "papermoney image"
                )
                Card(
                    modifier = Modifier
                    ...
                    colors = CardDefaults.cardColors(
                        containerColor = Color(0x999FA5B0)
                    )
                ) {
                    Box(
