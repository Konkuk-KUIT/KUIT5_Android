...
@Immutable
data class BankSaladTypeography(
    //Head
...
val defaultBankSaladTypeography = BankSaladTypeography(
    //Head
...
val LocalBankSaladTypographyProvider = staticCompositionLocalOf { defaultBankSaladTypeography }
